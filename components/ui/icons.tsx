...
export function IconXai({ className, ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export const IconMaux = ({ className, ...props }: React.ComponentProps<'svg'>) => {
  return (
    <svg
      aria-label="Custom SVG"
      width="523" height="591"
      viewBox="0 0 523 591"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className={className}
      {...props}
    >
      <path d="M522.188 590.625H509.412C469.151 590.625 435.471 579.774 408.372 558.071C380.499 536.368 366.562 501.876 366.562 454.595L366.563 1.32073e-05H373.531C391.339 1.32073e-05 409.146 2.32533 426.954 6.97592C443.988 11.6265 459.86 18.9899 474.571 29.0662C488.507 39.9176 500.121 53.4818 509.412 69.7589C517.929 86.811 522.188 107.739 522.188 132.542V590.625Z" fill="currentcolor"/>
<path d="M326.25 590.625H195V0H326.25C326.25 230.653 326.25 359.972 326.25 590.625Z" fill="currentcolor"/>
<path d="M0 590.625H12.7752C53.0364 590.625 86.7164 579.774 113.815 558.071C141.688 536.368 155.625 501.876 155.625 454.595L155.625 1.32073e-05H148.657C130.849 1.32073e-05 113.041 2.32533 95.2332 6.97592C78.1996 11.6265 62.3274 18.9899 47.6166 29.0662C33.68 39.9176 22.0662 53.4818 12.7752 69.7589C4.2584 86.811 0 107.739 0 132.542V590.625Z" fill="currentcolor"/>
<path d="M318.75 0H375V121.875H318.75V0Z" fill="currentcolor"/>
<path d="M148 0H204.25V121.875H148V0Z" fill="currentcolor"/>
    </svg>
